...
RUS_EXAMPLES = [
    ...
    (u"пользователь получит доступ .", 'Doc (ActorDoes ActorUser Get Access)', ''),
    ...
    (u"группа станет процессом .", 'Doc (ActorDoes ActorGroup Become AProcess)', 'l'),
    ...
    (u"задание исправится .", 'Doc (WillDo Update Task)', 'l'),
    (u"связанная внутренняя система получилась .", 'Doc (Done Get (AdjKind Connected (AdjKind Internal System)))', ''),
    ...
    (u"система будет помогать созданному пользователю .", 'Doc (ActorWillDo ActorSystem Help2 (AdjKind Created User))', ''),
    (u"пользователь выбрал связанную систему .", 'Doc (ActorDone ActorUser Select (AdjKind Connected System))', ''),
...
ENG_EXAMPLES = [
    ...
    (u"user selected connected system.", 'Doc (ActorDone ActorUser Select (AdjKind Connected System))', ''),
...
FIN_EXAMPLES = [
    ...
    (u"käyttäjä valitsi liittyvän järjestelmän.", 'Doc (ActorDone ActorUser Select (AdjKind Connected System))', ''),  # TODO:
